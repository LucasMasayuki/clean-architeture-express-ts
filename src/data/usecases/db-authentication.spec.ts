...
const makeSut = (): SutTypes => {
  ...
  TestContainer.bind(HASH_COMPARER_SYMBOL).toConstantValue(hashComparerSpy)
  TestContainer.bind(ENCRYPTER_SYMBOL).toConstantValue(encrypterSpy)

  const sut = TestContainer.resolve(DbAuthentication)
